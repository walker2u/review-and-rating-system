    ...
    <div class="container">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="progress">
                            <div class="progress-bar bg-warning" role="progressbar" style="width:50%;" aria-valuenow="0"
        ...
        while ($row = mysqli_fetch_array($res)) {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        <?php echo $row['user_rating']; ?> Stars
                    </h5>
                    <p class="card-text">
                ...
                <div class="card-header">
                    <p style="margin-bottom:0;" class="float-right">Reviewed On
            ...
            <form action="includes/review.php" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Review"
                            name="review">
                    </div>
                </div>
